# Challenge_Alaya guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `challenge_alaya/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `challenge_alaya` folder and use the modules inside your notebooks :
...
```python
from challenge_alaya.utils.paths import data_dir
data_dir()
```
